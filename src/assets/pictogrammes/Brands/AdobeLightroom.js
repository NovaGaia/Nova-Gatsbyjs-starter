...
function SvgAdobeLightroom(props) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <path
        d="M12.728 15.5h-4.4V8.086h1.353v6.281h3.047V15.5zM14.611 15.5h-1.353v-3.63c0-.726-.01-1.243-.044-1.727h1.177l.044 1.023h.044c.264-.759.891-1.144 1.463-1.144.132 0 .21.011.32.033v1.276a1.881 1.881 0 00-.397-.044c-.649 0-1.089.418-1.21 1.023a2.322 2.322 0 00-.044.418V15.5z"
        fill="#000"
      />
      <path
        fillRule="evenodd"
